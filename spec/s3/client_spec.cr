  ...
  describe Client do
    ...
    describe "batch_delete" do
      it "can can fail to delete items" do
        ...
        WebMock.stub(:post, "http://#{Aws::S3::SERVICE_NAME}.#{REGION}.amazonaws.com/bucket?delete")
    ...
    describe "put_bucket" do
      it "creates a bucket" do
        WebMock.stub(:put, "http://#{Aws::S3::SERVICE_NAME}.#{REGION}.amazonaws.com/bucket")
          .to_return(body: "")
      ...
      it "can create a bucket with a region" do
        ...
        WebMock.stub(:put, "http://#{Aws::S3::SERVICE_NAME}.#{REGION}.amazonaws.com/bucket2")
          .with(body: body)
          .to_return(body: "")
    ...
    describe "delete_bucket" do
      it "returns true when buckest is deleted" do
        WebMock.stub(:delete, "http://#{Aws::S3::SERVICE_NAME}.#{REGION}.amazonaws.com/bucket")
    ...
    describe "abort_multipart_upload" do
      it "aborts an upload" do
        WebMock.stub(:delete, "http://#{Aws::S3::SERVICE_NAME}.#{REGION}.amazonaws.com/bucket/object?uploadId=upload_id")
    ...
    describe "start_multipart_upload" do
      it "starts a multipart upload" do
        WebMock.stub(:post, "http://#{Aws::S3::SERVICE_NAME}.#{REGION}.amazonaws.com/bucket/object?uploads")
    ...
    describe "upload_part" do
      it "uploads a part" do
        WebMock.stub(:put, "http://#{Aws::S3::SERVICE_NAME}.#{REGION}.amazonaws.com/bucket2/obj2?partNumber=1&uploadId=123")
          .with(body: "test")
    ...
    describe "complete_multipart_upload" do
      it "completes a multipart upload" do
        ...
        WebMock.stub(:post, "http://#{Aws::S3::SERVICE_NAME}.#{REGION}.amazonaws.com/bucket/object?uploadId=upload_id")
          .with(body: post_body)
    ...
    describe "delete_object" do
      it "returns true if object deleted" do
        WebMock.stub(:delete, "http://s3.#{REGION}.amazonaws.com/blah/obj?")
          .to_return(status: 204)
    ...
    describe "put_object" do
      it "can do a basic put" do
        ...
        WebMock.stub(:put, "http://s3.#{REGION}.amazonaws.com/mybucket/object.txt")
          .with(body: "Hello")
    ...
    describe "list_objects" do
      it "handles pagination" do
        ...
        WebMock.stub(:get, "http://#{Aws::S3::SERVICE_NAME}.#{REGION}.amazonaws.com/bucket?list-type=2&max-keys=1&continuation-token=token")
          .to_return(body: resp2)

        WebMock.stub(:get, "http://#{Aws::S3::SERVICE_NAME}.#{REGION}.amazonaws.com/bucket?list-type=2&max-keys=1")
          .to_return(body: resp)
      ...
      it "supports basic case" do
        ...
        WebMock.stub(:get, "http://s3.#{REGION}.amazonaws.com/blah?list-type=2")
          .to_return(body: resp)
    ...
    describe "list_buckets" do
      it "returns buckets on success" do
        ...
        WebMock.stub(:get, "http://s3.#{REGION}.amazonaws.com/?")
          .to_return(body: resp)
    ...
    describe "head_bucket" do
      it "raises if bucket does not exist" do
        WebMock.stub(:head, "http://s3.#{REGION}.amazonaws.com/blah2?")
      ...
      it "returns true if bucket exists" do
        WebMock.stub(:head, "http://s3.#{REGION}.amazonaws.com/blah?")
