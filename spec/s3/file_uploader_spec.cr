  ...
  describe FileUploader do
    describe "when the file is smaller than 5MB" do
      it "uploads it in one call" do
        WebMock.stub(:put, "http://s3.#{REGION}.amazonaws.com/bucket/object?")
          .with(body: "document")
    ...
    describe "when the file is larger than 5MB" do
      it "uploads it in chunks" do
        ...
        WebMock.stub(:post, "http://s3.#{REGION}.amazonaws.com/bucket/object")
          .with(query: {"uploads" => ""})
        ...
        WebMock.stub(:post, "http://s3.#{REGION}.amazonaws.com/bucket/object?uploadId=123")
